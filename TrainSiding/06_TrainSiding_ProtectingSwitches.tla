This model of the train siding prevents switches from changing once one of the corresponding semaphores has changed to "GO".
This is a very important feature of interlockings.
But now we have another deadlock - can you see why?
---------------------------- MODULE 06_TrainSiding_ProtectingSwitches ----------------------------
