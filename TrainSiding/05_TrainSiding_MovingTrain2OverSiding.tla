Another model of the train siding.
Now both switches can change their state so that both trains can path each other and reach their destinations.
But TLC still finds a situation in which the trains can crash - it occurs when switch 2 changes its state after semaphore 4
has changed to "GO". 
A real interlocking needs to protect trains against this.
---------------------------- MODULE 05_TrainSiding_MovingTrain2OverSiding ----------------------------
