A very simple model of the train siding.
The trains both move in a straight line, so eventually they will collide as there is no protection yet.
---------------------------- MODULE 01_TrainSiding_StraightLine ----------------------------
